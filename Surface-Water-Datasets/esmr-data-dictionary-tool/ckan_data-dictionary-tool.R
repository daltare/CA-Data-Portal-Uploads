...
# Enter Location of "Start_Server.bat" and "Stop.bat" files
    bat_file_location <- 'C:\\Users\\daltare\\OneDrive - Water Boards\\projects\\CA_data_portal\\SMARTS\\'
...
# Enter variables:
    ...
    dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
    dataset_name <- 'esmr-reports-test'
    # data_resource_id <- '16ecdef6-25ef-4779-99a1-1b78f8f08b30' # 2021
    # data_resource_id <- '1bd86127-f707-4f7b-9558-387b2f9d3787' # 2017
    data_resource_id <- '2b693539-065a-453e-9207-83c693a40799' # 2016
