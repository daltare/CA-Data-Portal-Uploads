...
data_dictionaries_path <- 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN\\data_dictionary_conversion'
data_files_path <- 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN\\data_download\\CEDEN_Datasets'
