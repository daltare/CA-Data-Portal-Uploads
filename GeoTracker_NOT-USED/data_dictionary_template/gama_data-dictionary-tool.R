...
# Enter variables:
    ...
    # GAMA Water Quality
    dictionary_filename <- 'geotracker-gama-data-dictionary.xlsx'
    dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
    dataset_name <- 'ground-water-water-quality-results'
    data_resource_id <- '5cef96fd-6f7b-4a83-ac83-aea62d437552'
