...
2.  In your account dashboard, click on the **My Organizations** tab, then click on the **California State Water Resources Control Board** icon (NOTE: you should be automatically taken to the dashboard page after logging in to your account; you can also access the dashboard page by clicking on the dashboard icon (which looks like a speed dial) in the upper right side of the data.ca.gov webpage, next to your user name).
\nopagebreak
