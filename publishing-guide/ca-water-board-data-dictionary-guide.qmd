...
The table below shows the suggested structure of the data dictionary file. You can download a template data dictionary file in Excel format [here](https://github.com/daltare/CA-Data-Portal-Uploads/raw/refs/heads/main/publishing-guide/CA_Water_Board_Data_Dictionary_Template.xlsx).
