...
# Toxicity
dictionary_filename <- 'CEDEN_Toxicity_Data_Dictionary.xlsx'
dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
dataset_name <- 'surface-water-toxicity-results'
data_resource_id <- 'bd484e9b-426a-4ba6-ba4d-f5f8ce095836'

# # Toxicity Summary Results
# dictionary_filename <- 'CEDEN_ToxicitySummary_Data_Dictionary.xlsx'
# dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
# dataset_name <- 'surface-water-toxicity-results'
# data_resource_id <- '674474eb-e093-42de-aef3-da84fd2ff2d8'

# # Toxicity Replicate Results
# dictionary_filename <- 'CEDEN_ToxicityReplicate_Data_Dictionary.xlsx'
# dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
# dataset_name <- 'surface-water-toxicity-results'
# data_resource_id <- '6fd7b8d7-f8dd-454f-98bb-07e8cc710db8'
