...
# Enter variables:
    ...
    # # Habitat: prior to 2000
    # dictionary_filename <- 'CEDEN_Habitat_Data_Dictionary.xlsx'
    # dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
    # dataset_name <- 'surface-water-habitat-results'
    # data_resource_id <- '1eef884f-9633-45e0-8efb-09d48333a496'
    
    # # Habitat: 2000 - 2009
    # dictionary_filename <- 'CEDEN_Habitat_Data_Dictionary.xlsx'
    # dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
    # dataset_name <- 'surface-water-habitat-results'
    # data_resource_id <- '5bc866af-c176-463c-b513-88f536d69a28'
    
    # Habitat: 2010 - Present
    dictionary_filename <- 'CEDEN_Habitat_Data_Dictionary.xlsx'
    dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
    dataset_name <- 'surface-water-habitat-results'
    data_resource_id <- 'fe54c1c5-c16b-4507-8b3b-d6563df98e95'
