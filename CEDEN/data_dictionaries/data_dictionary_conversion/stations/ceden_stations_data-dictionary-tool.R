...
# Enter variables:
    ...
    # Stations
    dictionary_filename <- 'CEDEN_Stations_Data_Dictionary.xlsx'
    dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
    dataset_name <- 'surface-water-sampling-location-information'
    data_resource_id <- 'a927cb45-0de1-47e8-96a5-a5290816797b'
