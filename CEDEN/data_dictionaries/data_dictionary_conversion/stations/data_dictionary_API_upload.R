...
dictionary_file <- here("data_dictionaries", "data_dictionary_conversion", "stations", 
                        "CEDEN_Stations_Data_Dictionary.xlsx")
...
## get functions
source(here("data_dictionaries", "data_dictionary_conversion", "stations", 
