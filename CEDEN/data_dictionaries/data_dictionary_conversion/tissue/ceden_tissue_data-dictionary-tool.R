...
# Enter variables:
    ...
    # # Tissue: prior to 2000
    # dictionary_filename <- 'CEDEN_Tissue_Data_Dictionary.xlsx'
    # dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
    # dataset_name <- 'surface-water-aquatic-organism-tissue-sample-results'
    # data_resource_id <- 'ed646127-50e1-4163-8ff6-d30e8b8056b1'
    
    # Tissue: 2000 - 2009
    dictionary_filename <- 'CEDEN_Tissue_Data_Dictionary.xlsx'
    dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
    dataset_name <- 'surface-water-aquatic-organism-tissue-sample-results'
    data_resource_id <- '6890b717-19b6-4b1f-adfb-9c2874c8012e'
    
    # # Tissue: 2010 - Present
    # dictionary_filename <- 'CEDEN_Tissue_Data_Dictionary.xlsx'
    # dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
    # dataset_name <- 'surface-water-aquatic-organism-tissue-sample-results'
    # data_resource_id <- '5d4d572b-004b-4e2b-b26c-20ef050c018f'
