...
first = 'C:\David\Open_Data_Project\__CA_DataPortal\CEDEN_PythonScript'
...
For_SafeToSwim = True # if True, create the SafeToSwim file - NOTE: in order to create this file, the WaterChemistryData element needs to be included in the tables variable
For_Pesticides = True # if True, create the pesticides file - NOTE: in order to create this file, the WaterChemistryData element needs to be included in the tables variable
...
def data_retrieval(tables, saveLocation, sep, extension):
	...
	for count, (filename, table) in enumerate(tables.items()):
		...
		filename_1950 = os.path.join(saveLocation, '%s%s' % (filename + range_1950 + "_" + today, extension))
		filename_2000 = os.path.join(saveLocation, '%s%s' % (filename + range_2000 + "_" + today, extension))
		filename_2010 = os.path.join(saveLocation, '%s%s' % (filename + range_2010 + "_" + today, extension))
...
#		      "BenthicData": "BenthicDMart_MV", "HabitatData": "HabitatDMart_MV", }
	...
	with open(AllSites_path, 'w', newline='', encoding='utf8') as AllSites_csv_file:
		AllSites_dw = csv.DictWriter(AllSites_csv_file,
                               s=['StationName', 'SiteCode', 'Latitude', 'Longitude',
                                  'Datum', ], delimiter=sep, lineterminator='\n')
		AllSites_dw.writeheader()
...
WaterChem = FILES["WaterChemistryData"]
path, fileName = os.path.split(WaterChem)
newFileName = 'Organics_DataMartList' + "_" + today + extension
column_filter = 'Analyte'
name, location, sitesname, siteslocation = selectByAnalyte(path=path, fileName=fileName, newFileName=newFileName, analytes=analytes,
		                field_filter=column_filter, sep=sep)
FILES[name] = location
...
WaterChem = FILES["WaterChemistryData"]
path, fileName = os.path.split(WaterChem)
newFileName = 'Pesticides_v2' + "_" + today + extension
column_filter = 'Analyte'
name, location, sitesname, siteslocation = selectByAnalyte(path=path, fileName=fileName, newFileName=newFileName, analytes=analytes,
		                field_filter=column_filter, sep=sep)
FILES[name] = location
...
uploads = {FILES['SafeToSwim' + '_' + today + '.csv']: 2396,
...
#           FILES['Sites_for_SafeToSwim' + '_' + today + '.csv']: 2401, }
uploads_names = {'SafeToSwim' + '_' + today + '.csv': 2396,
...
## try to upload the other chemistry datasets
#uploads_chemistry = {FILES['WaterChemistryData_2000-2009']: 2381, FILES['WaterChemistryData_2010-present']: 2326, }
#uploads_chemistry_names = {'WaterChemistryData_2000-2009': 2381, 'WaterChemistryData_2010-present': 2326, }
#
#    # create a text file to act as a log
#		saveLocation = os.path.join(first, 'Upload_Logs')		
#		log_file = saveLocation + '\\' + today + '_Chemistry' + '.txt'
#		outF = open(log_file, "w")
#		outF.write('MESSAGES FROM THE API UPLOAD SCRIPT:\n')
#    # Run the script to upload the csv files via the API
#		for file in uploads_chemistry:
#			print("Starting to upload %s to Data.ca.gov" % os.path.basename(file))
#			outF.write("Starting to upload %s to Data.ca.gov" % os.path.basename(file))
#			r = api.attach_file_to_node(file=file, node_id=uploads_chemistry[file], field='field_upload', update=0)
#			if r.ok:
#				print("Completed uploading %s to data.ca.gov" % os.path.split(file)[1])
#				outF.write("Completed uploading %s to data.ca.gov\n\n" % os.path.split(file)[1])
#				r.close()
#				del r
#			else:
#				print("Error with %s. Here is the response error code: %s " % (os.path.split(file)[1], r.status_code))
...
#				print(r.text)
#				print(r.reason)
#				outF.write("Error with %s. Here is the response error code: %s " % (os.path.split(file)[1], r.status_code))
#				outF.write("  - Here is the response text:")
#				outF.write(r.text)
#				outF.write(r.reason)
#				outF.write('\n\n')
...
#		outF.write('\n\n\n================================================================================================\n')
#		outF.write('CHECK: Retrieve the filename of the file on the data portal for each dataset updated via the API\n')
#		for file_name in uploads_chemistry_names:
#			node_id=uploads_chemistry_names[file_name]
#			r = api.node('retrieve', node_id = node_id)
#			node_info = r.json()
#			current_dataportal_filename = node_info['field_upload']['und'][0]['filename']
#			outF.write('Dataset: ' + file_name)
...
#FILES = {'All_CEDEN_Sites': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\All_CEDEN_Sites_2018-07-13.csv',
# 'BenthicData': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\BenthicData_2018-07-13.csv',
# 'BenthicData_2000-2009': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\BenthicData_2000-2009_2018-07-13.csv',
# 'BenthicData_2010-present': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\BenthicData_2010-present_2018-07-13.csv',
# 'BenthicData_prior_to_1999': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\BenthicData_prior_to_1999_2018-07-13.csv',
# 'HabitatData': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\HabitatData_2018-07-13.csv',
# 'HabitatData_2000-2009': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\HabitatData_2000-2009_2018-07-13.csv',
# 'HabitatData_2010-present': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\HabitatData_2010-present_2018-07-13.csv',
# 'HabitatData_prior_to_1999': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\HabitatData_prior_to_1999_2018-07-13.csv',
# 'Pesticides_2018-07-13.csv': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\Pesticides_2018-07-13.csv',
# 'SafeToSwim_2018-07-13.csv': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\SafeToSwim_2018-07-13.csv',
# 'Sites_for_Pesticides_2018-07-13.csv': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\Sites_for_Pesticides_2018-07-13.csv',
# 'Sites_for_SafeToSwim_2018-07-13.csv': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\ites_for_SafeToSwim_2018-07-13.csv',
# 'TissueData': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\TissueData_2018-07-13.csv',
# 'TissueData_2000-2009': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\TissueData_2000-2009_2018-07-13.csv',
# 'TissueData_2010-present': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\TissueData_2010-present_2018-07-13.csv',
# 'TissueData_prior_to_1999': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\TissueData_prior_to_1999_2018-07-13.csv',
# 'ToxicityData': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\ToxicityData_2018-07-13.csv',
# 'ToxicityData_2000-2009': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\ToxicityData_2000-2009_2018-07-13.csv',
# 'ToxicityData_2010-present': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\ToxicityData_2010-present_2018-07-13.csv',
# 'ToxicityData_prior_to_1999': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\ToxicityData_prior_to_1999_2018-07-13.csv',
# 'WQX_Stations': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\WQX_Stations_2018-07-13.csv',
# 'WaterChemistryData': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\WaterChemistryData_2018-07-13.csv',
# 'WaterChemistryData_2000-2009': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\WaterChemistryData_2000-2009_2018-07-13.csv',
# 'WaterChemistryData_2010-present': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\WaterChemistryData_2010-present_2018-07-13.csv',
# 'WaterChemistryData_prior_to_1999': 'C:\\David\\Open_Data_Project\\__CA_DataPortal\\CEDEN_PythonScript\\CEDEN_Datasets\\WaterChemistryData_prior_to_1999_2018-07-13.csv'}