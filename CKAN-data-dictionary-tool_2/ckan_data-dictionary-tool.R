...
# Enter variables:
    ...
    dictionary_fields <- c('column', 'type', 'label', 'description') # has to be in order: Column, Type, Label, Description
    dataset_name <- 'drinking-water-public-water-system-operations-monthly-water-production-and-conservation-information'
    data_resource_id <- '0c231d4c-1ea7-43c5-a041-a3a6b02bac5e'
