...
# STEP 3: Run the function to download text file data from SMARTS - loop through all of the datasets defined at the top of the script in the 'dataset_list' variable ----
        # # # FOR TESTING -----------------------------------!
        # test_counter <- 7
        # filename <- dataset_list[[test_counter]]$filename
        # html_id <- dataset_list[[test_counter]]$html_id
        # resource_id <- dataset_list[[test_counter]]$resource_id
        # fields_dates <- dataset_list[[test_counter]]$date_fields
        # fields_times <- dataset_list[[test_counter]]$time_fields
        # fields_timestamps <- dataset_list[[test_counter]]$timestamp_fields
        # fields_numeric <- dataset_list[[test_counter]]$numeric_fields
        # # # -----------------------------------------------!
